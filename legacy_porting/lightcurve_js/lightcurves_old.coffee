# Straight up translation of the old lightcurve JS into coffeescript
# ... as an intermediate step to replace the codebase
# Comments have been also translated to CS.
# ERB code has been converted to @variables, and noted in comments
